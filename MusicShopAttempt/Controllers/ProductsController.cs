...
namespace MusicShopAttempt.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Products.Include(p => p.Genre).Include(p => p.Singer);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Quantity,Description,Picture,Price,EntryDate,Status,Promo,Holder,Category,SingerId,GenreId")] Product product)
        {
