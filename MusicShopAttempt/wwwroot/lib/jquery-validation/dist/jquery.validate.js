...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Поправете съдържанието на полето.",
		...
		digits: "Моля въведете само числа.",
		equalTo: "Моля въведете същата стойност.",
		maxlength: $.validator.format( "Моля въведете не повече от {0} знака." ),
		minlength: $.validator.format( "Моля въведете поне {0} знака." ),
		rangelength: $.validator.format( "Моля въведената стойност да съдържа от {0} до {1} знака." ),
		range: $.validator.format( "Моля въведете стойност между {0} и {1}." ),
		max: $.validator.format( "Моля въведете стойност по-малка или равна на {0}." ),
		min: $.validator.format("Моля въведете стойност по-голяма или равна на {0}." ),
		step: $.validator.format("Моля въведете няколко от {0} .")
	},
